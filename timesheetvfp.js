<apex:page controller="TimesheetInterfaceController" standardstylesheets="true" title="Timesheet Test" doctype="html-5.0" sidebar="false" id="pg">
<apex:detail id="ytho"/>
<apex:stylesheet value="{!URLFOR($Resource.fullcalendar290, 'fullcalendar-2.9.0/fullcalendar.css')}"/>
<apex:includeScript value="{!URLFOR($Resource.fullcalendar290, 'fullcalendar-2.9.0/lib/moment.min.js')}"/>
<apex:includeScript value="{!URLFOR($Resource.fullcalendar290, 'fullcalendar-2.9.0/lib/jquery.min.js')}"/>
<apex:includeScript value="{!URLFOR($Resource.fullcalendar290, 'fullcalendar-2.9.0/fullcalendar.min.js')}"/>
<link href="{!URLFOR($Resource.et4ae5__bootstrap, 'dist/css/bootstrap.min.css')}" rel="stylesheet"/>
<link href="{!URLFOR($Resource.et4ae5__bootstrap, 'dist/css/bootstrap-theme.min.css')}" rel="stylesheet"/>
<meta charset="utf-8"/>
...
<html id="1"> <!--ffbb22-->
<div class="row" style="background:white;" id="2">
    <div id="calendar" class="col-md-9"/>
    <div class="col-md-3">
        <div id="TSI-info" class="row">
            <div id="dataform" class="col-md-7" >
                <button id="upload" onclick="uploadTimesheet()" class="btn btn-primary">Save Changes</button>
                <button id="deleteButton" onclick="deleteCurrentTSI()" class="btn btn-primary">Delete</button>
                <br/>
                <h2 id="currentTSIHeader">No Item Selected<br/></h2>
                ...
                <p>Total Time: <br/>
                    <input type="text" id="totalTime"/></p>

                    <p>Earnings Code:<br/>
                        <select id="Earnings_Code__c" onchange="saveECandPA"/>
                        <!--<apex:inputField value="{!timesheetItem.Earnings_Code__c}" styleclass="earning-code" id="Earnings_Code__c" onchange="saveECandPA();">
                            <apex:actionSupport event="onclick" rerender="{!$Component.pg.apexFormECPA.yTho}" action="{!derp}"/>
                        </apex:inputField>-->
                    </p>

                    <p>Project Activity:<br/>
                        <select id="Type__c" onchange="saveECandPA"/>
                        <!--<apex:outputPanel id="yTho">
                            <apex:inputField value="{!timesheetItem.Type__c}" styleclass="type" id="Type__c_values" onchange="saveECandPA();"/>
                        </apex:outputPanel>-->
                    </p>

                <p>Time Snap Interval(Max 10):<br/>
                    <input type="text" value="01" id="timeInterval" onchange="" style="vertical-align: text-bottom;"/>
                </p>

                <p>Total time worked
                    <input type="text" id="totalTimeWorked"/>
                </p>

                <p>Total cap time
                    <input type="text" id="totalCapTime"/>
                </p>
            </div>

            <div id="lookupFields" class="col-md-4" >
                <apex:form id="apexFormLookupFields">
                    <p>Capital Project:<br/>
                        <apex:inputField value="{!timesheetItem.Capital_Project__c}" id="Capital_Project__c"/></p>
                    <p>Capital Subproject:<br/>
                        <apex:inputField value="{!timesheetItem.Capital_Subproject__c}" id="Capital_Subproject__c"/></p>
                    <p>Internal SO:<br/>
                        <apex:inputField value="{!timesheetItem.Internal_Service_Order__c}" id="Internal_Service_Order__c"/></p>
                    <p>Case Info:<br/>
                        <apex:inputField value="{!timesheetItem.Case__c}" id="Case__c"/></p>
                    <p>Service Info:<br/>
                        <apex:inputField value="{!timesheetItem.Service__c}" id="Service__c"/></p>
                    <p>Opportunity Info:<br/>
                        <apex:inputField value="{!timesheetItem.Opportunity__c}" id="Opportunity__c"/></p>
                    <p>Account Info:<br/>
                        <apex:inputField value="{!timesheetItem.Account__c}" id="Account__c"/></p>
                    <p>Real Estate Project Info:<br/>
                        <apex:inputField value="{!timesheetItem.Real_Estate_Project__c}" id="Real_Estate_Project__c"/></p>

                </apex:form>
            </div>
        </div>

        <div class="row fill-height" id="debug">
            Database Log:
        </div>
    </div>
</div>
...
<style>
    ...
    .fc-event {
        border-width: 2px;//this is the css formatting for the event inner text
        border-radius: 8px;
        font-family: Arial;
        font-size: 13px;//13px is default
    }
</style>
</apex:page>
